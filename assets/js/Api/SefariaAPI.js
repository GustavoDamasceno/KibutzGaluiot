...
async function fetchData(url) {
    try {
        ...
        var dates = [diaAtual + "/" + mesAtual + "/" + anoAtual + " - " + data.calendar_items[12].displayValue.en, data.calendar_items[12].displayValue.he, data.calendar_items[0].title.en + ": " + data.calendar_items[0].displayValue.en ,data.calendar_items[0].title.he + ": " + data.calendar_items[0].displayValue.he];
        var currentIndex = 0;
